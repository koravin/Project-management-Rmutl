...
// Component Import
import Preproject_Detail_Component from './Preproject_Detail_Component'
import Preproject_Upload_Component from './Preproject_Upload_Component'

const Transition = React.forwardRef(function Transition(props, ref) {
  return <Slide direction='up' ref={ref} {...props} />
})

export default function Preproject_Detail_Modal({ open, handleClose, rowData }) {
      ...
      >
        ...
        <Box display='flex' flexDirection='column' justifyContent='center' height='auto' marginTop='5vh' margin='2vh'>
          <TabContext value={value}>
            ...
            <TabPanel value='1'>
              <Box width='100%'>
                <Preproject_Detail_Component project_id={project_id} />
              </Box>
            </TabPanel>
            <TabPanel value='2'>
              <Preproject_Upload_Component project_id={project_id} />
            </TabPanel>
          </TabContext>
        </Box>
      </Dialog>
