...
// Component Import
import Sec_pro_detail from './Sec_pro_detail'
import Sec_pro_doc from './Sec_pro_doc'

const Transition = React.forwardRef(function Transition(props, ref) {
  return <Slide direction='up' ref={ref} {...props} />
})

export default function Project_section_detail({ open, handleClose, rowData }) {
      ...
      >
        ...
        <Box display='flex' flexDirection='column' justifyContent='center' height='auto' marginTop='5vh' margin='2vh'>
          <TabContext value={value}>
            ...
            <TabPanel value='1'>
              <Box width='100%'>
                <Sec_pro_detail project_id={project_id} />
              </Box>
            </TabPanel>
            <TabPanel value='2'>
              <Sec_pro_doc project_id={project_id} />
            </TabPanel>
          </TabContext>
        </Box>
      </Dialog>
