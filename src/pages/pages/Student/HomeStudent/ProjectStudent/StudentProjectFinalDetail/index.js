...
import Document_project_status from './Document_project_status'

const Transition = React.forwardRef(function Transition(props, ref) {
  return <Slide direction='up' ref={ref} {...props} />
})

export default function StudentProjectFinalDetail({ open, handleClose, rowData }) {
      ...
      >
        ...
        <Box display='flex' flexDirection='column' justifyContent='center' height='auto' marginTop='5vh' margin='2vh'>
          <TabContext value={value}>
            ...
            <TabPanel value='1'>
              <Box width='100%'>
                <Detail_project_student project_id={project_id} />
              </Box>
            </TabPanel>
            <TabPanel value='2'>
            ...
            <TabPanel value='3'>
              <Document_project_status project_id={project_id} />
            </TabPanel>
            <TabPanel value='4'>
