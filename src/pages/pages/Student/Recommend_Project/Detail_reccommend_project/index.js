...
// Component Import
import Reccomment_project_detail from './Reccomment_project_detail'
import Reccomment_document_detail from './Reccomment_document_detail'

const Transition = React.forwardRef(function Transition(props, ref) {
  return <Slide direction='up' ref={ref} {...props} />
})

export default function Detail_reccommend_project({ open, handleClose, rowData }) {
      ...
      >
        ...
        <Box display='flex' flexDirection='column' justifyContent='center' height='auto' marginTop='5vh' margin='2vh'>
          <TabContext value={value}>
            ...
            <TabPanel value='1'>
              <Box width='100%'>
                <Reccomment_project_detail project_id={project_id} />
              </Box>
            </TabPanel>
            <TabPanel value='2'>
              <Reccomment_document_detail project_id={project_id} />
            </TabPanel>
          </TabContext>
        </Box>
      </Dialog>
