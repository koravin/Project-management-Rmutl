...
// Component Import
import Load_preproject_modal from './Load_preproject_modal'
        ...
        <CardContent>
          <Grid>
            <Box sx={{ height: '100%', width: '100%' }}>
              ...
              ) : loadPreprojectData.length === 0 ? (
                <p>No Data</p>
              ) : (
                <DataGrid
                  rows={loadPreprojectData}
                  columns={columns}
...
export default Preproject_load
