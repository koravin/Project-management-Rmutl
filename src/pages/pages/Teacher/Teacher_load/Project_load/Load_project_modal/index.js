...
// Component Import
import Load_project_detail from './Load_project_detail'
import Load_project_document from './Load_project_document'

const Transition = React.forwardRef(function Transition(props, ref) {
  return <Slide direction='up' ref={ref} {...props} />
})

export default function Load_project_modal({ open, handleClose, rowData }) {
      ...
      >
        ...
        <Box display='flex' flexDirection='column' justifyContent='center' height='auto' marginTop='5vh' margin='2vh'>
          <TabContext value={value}>
            ...
            <TabPanel value='1'>
              <Box width='100%'>
                <Load_project_detail project_id={project_id} />
              </Box>
            </TabPanel>
            <TabPanel value='2'>
              <Load_project_document project_id={project_id} />
            </TabPanel>
          </TabContext>
        </Box>
      </Dialog>
