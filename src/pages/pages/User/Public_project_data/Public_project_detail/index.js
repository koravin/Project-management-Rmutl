...
// Component Import
import Public_document_preview from './Public_document_preview'
import Public_detail_preview from './Public_detail_preview'

const Transition = React.forwardRef(function Transition(props, ref) {
  return <Slide direction='up' ref={ref} {...props} />
})

export default function Public_project_detail({ open, handleClose, rowData }) {
      ...
      >
        ...
        <Box display='flex' flexDirection='column' justifyContent='center' height='auto' marginTop='5vh' margin='2vh'>
          <TabContext value={value}>
            ...
            <TabPanel value='1'>
              <Box width='100%'>
                <Public_detail_preview project_id={project_id} />
              </Box>
            </TabPanel>
            <TabPanel value='2'>
              <Public_document_preview project_id={project_id} />
            </TabPanel>
          </TabContext>
        </Box>
      </Dialog>
